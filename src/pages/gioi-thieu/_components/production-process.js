  ...
  return (
    <Flex direction="column" bgColor="#FFF" pos="relative" px={{ xs: '18px', lg: 0 }}>
      <Flex direction="column" align="center">
        ...
        <Text textAlign="center" mt="16px" fontSize={16}>
            ...
            <Flex gap="8px" key={index} align="flex-end" pos="relative" zIndex={5}>
              <Flex direction="column" align="center" gap="12px">
                ...
                <Button
                  ...
                  _hover={{ opacity: 1, color: isActive ? '#FFF' : '#00b7e9' }}
                  _active={{ opacity: 1, color: isActive ? '#FFF' : '#00b7e9' }}
