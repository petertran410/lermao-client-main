...
const IntroWrapper = () => {
  ...
  const components = [
    { position: 130, component: Vision },
    { position: 600, component: Strength },
    { position: 1000, component: ProductProcess },
    { position: 1600, component: Statistic },
    { position: 1800, component: Feedback }
  ];
