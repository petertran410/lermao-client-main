...
const HomeIntro = () => {
  useEffect(() => {
    ...
    script.src = 'https://media.hisweetievietnam.com/products-png/embed-viewer.js?v=3';
    script.async = true;
    ...
    script.onload = async () => {
      await window.create3DModelEmbed({
        container: '#viewer',
        modelUrl: 'https://media.hisweetievietnam.com/products-png/models/dualuoi.glb',
  ...
  return (
    <>
      <Script
        type="module"
        src="https://media.hisweetievietnam.com/products-png/embed-viewer.js?v=3"
      ...
      >
        <Flex flex={2 / 5} direction="column">
          ...
          <Text mt="24px" fontSize={16} textAlign="justify">
            Gấu LerMao tự hào là thương hiệu dẫn đầu trong hoạt động cung cấp nguyên liệu pha chế toàn diện, sẵn sàng
            đồng hành cùng các chủ doanh nghiệp kinh doanh ngành F&B, coffee, trà sữa và đồ uống trên toàn quốc.
          </Text>
